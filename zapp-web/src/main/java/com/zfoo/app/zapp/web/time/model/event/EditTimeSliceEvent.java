 ...
 */
public class EditTimeSliceEvent implements IEvent {

    private TimeSliceEntity oldEntity;
    private TimeSliceEntity newEntity;
    private TimeSliceEntity currentEntity;

    public static EditTimeSliceEvent valueOf(TimeSliceEntity oldEntity, TimeSliceEntity newEntity, TimeSliceEntity currentEntity) {
        var event = new EditTimeSliceEvent();
        event.oldEntity = oldEntity;
        event.newEntity = newEntity;
        event.currentEntity = currentEntity;
        return event;
    }
    ...
    public TimeSliceEntity getCurrentEntity() {
