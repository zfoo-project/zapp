 ...
 */
public class RecommitTimeSliceEvent implements IEvent {

    private TimeSliceEntity oldEntity;
    private TimeSliceEntity newEntity;

    public static RecommitTimeSliceEvent valueOf(TimeSliceEntity oldEntity, TimeSliceEntity newEntity) {
        var event = new RecommitTimeSliceEvent();
