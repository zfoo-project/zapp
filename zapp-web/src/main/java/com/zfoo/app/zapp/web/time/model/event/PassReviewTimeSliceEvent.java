 ...
 */
public class PassReviewTimeSliceEvent implements IEvent {
    ...
    public static PassReviewTimeSliceEvent valueOf(TimeSliceEntity entity, boolean recommend) {
        var event = new PassReviewTimeSliceEvent();
        event.newEntity = entity;
