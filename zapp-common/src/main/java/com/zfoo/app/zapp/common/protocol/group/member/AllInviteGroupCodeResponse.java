 ...
 */
public class AllInviteGroupCodeResponse implements IPacket {

    public static final transient short PROTOCOL_ID = 18425;

    private List<InviteCodeVO> inviteCodes;

    public static AllInviteGroupCodeResponse valueOf(List<InviteCodeVO> inviteCodes) {
        var response = new AllInviteGroupCodeResponse();
