...
public class TsEditEntity implements IEntity<Long> {
    ...
    public static TsEditEntity valueOf(long id, long userId, TimeSliceEntity timeSlice) {
        var entity = new TsEditEntity();
        entity.id = id;
