 ...
 */
public class KickMemberPush implements IPacket {

    public static final transient short PROTOCOL_ID = 30222;

    private long targetId;
    private KickMemberNotice notice;

    public static KickMemberPush valueOf(long targetId, KickMemberNotice notice) {
        var push = new KickMemberPush();
