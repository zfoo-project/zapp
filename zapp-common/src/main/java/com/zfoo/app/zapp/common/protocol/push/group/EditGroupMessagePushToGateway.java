 ...
 */
public class EditGroupMessagePushToGateway implements IPacket {

    public static final transient short PROTOCOL_ID = 30305;

    private Set<Long> sidSet;

    private EditGroupMessageNotice notice;

    public static EditGroupMessagePushToGateway valueOf(Set<Long> sidSet, EditGroupMessageNotice notice) {
        var push = new EditGroupMessagePushToGateway();
        push.sidSet = sidSet;
        push.notice = notice;
        return push;
    }
