 ...
 */
public class GroupUpdatePushToGateway implements IPacket {

    public static final transient short PROTOCOL_ID = 30211;

    private Set<Long> sidSet;

    private GroupUpdateNotice notice;

    public static GroupUpdatePushToGateway valueOf(Set<Long> sidSet, GroupUpdateNotice notice) {
        var push = new GroupUpdatePushToGateway();
        push.sidSet = sidSet;
        push.notice = notice;
        return push;
    }
