 ...
 */
public class DeleteChannelResponse implements IPacket {

    public static final transient short PROTOCOL_ID = 18307;

    private GroupVO groupVO;

    public static DeleteChannelResponse valueOf(GroupVO groupVO) {
