...
public class InviteCodePO {
    ...
    public static InviteCodePO valueOf(String code, int expireType, long expireTime, int countType, int count) {
        var po = new InviteCodePO();
        po.code = code;
    ...
    public InviteCodeVO toInviteCodeVO() {
        return InviteCodeVO.valueOf(code, expireType, expireTime, countType, count);
    }
