 ...
 */
public class DeleteGroupPush implements IPacket {

    public static final transient short PROTOCOL_ID = 30200;

    private Set<Long> people;

    private DeleteGroupNotice notice;

    public static DeleteGroupPush valueOf(Set<Long> people, DeleteGroupNotice notice) {
        var push = new DeleteGroupPush();
        push.people = people;
        push.notice = notice;
        return push;
    }
