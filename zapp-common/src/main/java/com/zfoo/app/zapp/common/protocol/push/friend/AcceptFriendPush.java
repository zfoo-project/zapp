 ...
 */
public class AcceptFriendPush implements IPacket {

    public static final transient short PROTOCOL_ID = 30105;

    private List<Long> targetIdList;

    private NewFriendNotice notice;

    public static AcceptFriendPush valueOf(List<Long> targetIdList, NewFriendNotice notice) {
        var push = new AcceptFriendPush();
