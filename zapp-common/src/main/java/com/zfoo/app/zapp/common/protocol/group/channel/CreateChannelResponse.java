 ...
 */
public class CreateChannelResponse implements IPacket {

    public static final transient short PROTOCOL_ID = 18303;

    private GroupVO groupVO;

    public static CreateChannelResponse valueOf(GroupVO groupVO) {
