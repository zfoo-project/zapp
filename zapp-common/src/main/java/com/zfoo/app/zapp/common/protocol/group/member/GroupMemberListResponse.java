 ...
 */
public class GroupMemberListResponse implements IPacket {

    public static final transient short PROTOCOL_ID = 18431;

    private long groupId;
    private int page;
    private List<GroupMemberVO> members;

    public static GroupMemberListResponse valueOf(long groupId, int page, List<GroupMemberVO> members) {
