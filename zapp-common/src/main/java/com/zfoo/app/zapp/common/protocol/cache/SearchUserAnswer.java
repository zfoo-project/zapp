 ...
 */
public class SearchUserAnswer implements IPacket {

    public static final transient short PROTOCOL_ID = 3033;

    private List<UserCache> userCaches;

    public static SearchUserAnswer valueOf(List<UserCache> userCaches) {
        var response = new SearchUserAnswer();
