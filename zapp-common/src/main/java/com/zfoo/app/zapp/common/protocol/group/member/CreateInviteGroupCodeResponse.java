 ...
 */
public class CreateInviteGroupCodeResponse implements IPacket {

    public static final transient short PROTOCOL_ID = 18411;

    private List<InviteCodeVO> inviteCodes;

    public static CreateInviteGroupCodeResponse valueOf(List<InviteCodeVO> inviteCodes) {
        var response = new CreateInviteGroupCodeResponse();
